...
export function SubscriptionEditor({ active }: Props) {
  ...
  // Toggling a subscription does NOT auto-regenerate recommendations —
  // that's a heavy 3-call LLM run. The /recs page surfaces a "your
  // subscriptions changed" note instead, and the user refreshes when
  // they're ready.
